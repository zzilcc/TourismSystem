...
<div class="well well-lg">
	...
	<table class="table table-striped table-hover ">
	  ...
	  <tr>
			...
			?>
			<a class="btn btn-raised" href="addcus.php"><i class="material-icons">add</i> Add News</a>
	   	<?php	else:
				echo "Add News";
			?>
			<?php
	    ...
	    <th><i class="material-icons">watch_later</i> time</th>
	    <th><i class="material-icons">transfer_within_a_station</i> Traffic</th>
	...
	$sql_sce="SELECT * FROM  `traffic_num` ";
	...
	for($i=0; $i<$query_num; ++$i){
	  $query_info = mysqli_fetch_assoc($query);
		//var_dump($query_info);
		//echo $query_info;
	  echo " <td>$query_info[Scenename]</td><td>$query_info[time]</td><td>$query_info[Traffic]</td>";
//echo $query_info["id"];
  // var_dump($query_info);
		//echo $query_info;

	  if($_SESSION['authentication']==1)
      echo " <td><a href='updatecus.php?id=$query_info[id]'>Update</a></td><td><a href='deletecus.php?id= $query_info[id]'>Delete</a></td>";
	  else
