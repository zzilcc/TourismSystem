...
<div class="well well-lg">
	...
	<table class="table table-striped table-hover ">
	  ...
	  <tr>
			...
			if($_SESSION['authentication']==1):
					?>
			<a class="btn btn-raised" href="addnew.php"><i class="material-icons">add</i> Add News</a>
		<?php	else:
				echo "Add News";
	    ...
	    <th><i class="material-icons">fiber_new</i> news</th>
	...
	$sql_sce="SELECT * FROM  `latest_news` ";
	...
	for($i=0; $i<$query_num; ++$i){
	  $query_info = mysqli_fetch_assoc($query);
		//var_dump($query_info);
		//echo $query_info;
	  echo " <td>$query_info[Scenename]</td><td>$query_info[news]</td> ";
//echo $query_info["id"];
  // var_dump($query_info);
		//echo $query_info;

	  if($_SESSION['authentication']==1)
      echo " <td><a href='updatenew.php?id=$query_info[id]'>Update</a></td><td><a href='deletenew.php?id= $query_info[id]'>Delete</a></td>";
	  else
